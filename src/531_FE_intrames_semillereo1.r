...
AgregarVariables_IntraMes <- function(dataset) {
  ...
  dataset[, catm_trx_ttl := rowSums(cbind(catm_trx, catm_trx_other), na.rm = TRUE)]
  dataset[, matm_trx_ttl := rowSums(cbind(matm_other, matm), na.rm = TRUE)]
  ...
  dataset[, tiempo_nuevo_prod := cliente_antiguedad / cproductos]
