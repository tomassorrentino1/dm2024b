...
envg$EXPENV$exp_dir <- "~/buckets/b1/expwsemilleroteam/"
...
FEintra_base <- function( pinputexps )
{
  ...
  param_local$meta$script <- "/src/wf-etapas/531_FE_intrames_semillereo1.r"
...
DR_drifting_base <- function( pinputexps, metodo)
{
  ...
  param_local$meta$script <- "/src/wf-etapas/541_DR_semillereo1.r"
...
wf_sept_semillerio <- function( pnombrewf )
{
  ...
  CN_canaritos_asesinos_base(ratio=1.5, desvio=1.0)
